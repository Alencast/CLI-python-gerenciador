...
def test_token(request):
    """
    View para testar se o token está funcionando
    """
    return Response({
...
class TarefaViewSet(viewsets.ModelViewSet):
    ...
    def concluir(self, request, pk=None):
        """
        Endpoint para marcar/desmarcar tarefa como concluída
        ...
        Se não enviar body, alterna o status atual
        """
